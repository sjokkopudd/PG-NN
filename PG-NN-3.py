...
df = pd.read_csv("C:/Users/laach/Documents/Skole/Masteroppgave/Master2/Code/test-data-func3v2.csv")
...
for i2 in range(0,len(x_train2_pre)):
    #x_train2.append(dt*(x_train2_pre[i2])) # func1 side_input = x 
    #x_train2.append(dt*(cos(x_train2_pre[i2]))) # func2 side_input = cos(x)
    x_train2.append(dt*(1/sqrt(x_train2_pre[i2]))) # func3 side_input = 1/x 
    ...
    for guided_nn in range(0,nn_number):
        ...
        for ii in range(0,len(x_test-1)): 
            ...
            if ((ii+1)%int((len(x_test))/test_samples) == 0) and (ii != len(x_test)-1): #new start
                ...
                #Choose Function
                #side_input = dt*(predictions[ii][input_shape-1]) # func1
                #side_input = dt*(cos(predictions[ii][input_shape-1])) # func2
                side_input = dt*(1/sqrt(predictions[ii][input_shape-1])) # func3
...
line_plot_nn.savefig("line_figure_normal.3.pdf")
line_plot_l1.savefig("line_figure_l1.3.pdf")
line_plot_l2.savefig("line_figure_l2.3.pdf")
line_plot_l3.savefig("line_figure_l3.3.pdf")
line_plot_l4.savefig("line_figure_l4.3.pdf")

#### Training/Validation loss ####

# =============================================================================
# loss_plot = plt.figure()
# plt.plot(histories[3][0].history['loss'])
# plt.plot(histories[3][0].history['val_loss'])
...
# plt.show()
# loss_plot.savefig("train-val-loss.pdf")
# =============================================================================
#line_plot.savefig("line_figure_func3.v2.pdf")

bar_plot.savefig("bar_figure_func3.pdf")
