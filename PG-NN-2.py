...
df = pd.read_csv("C:/Users/laach/Documents/Skole/Masteroppgave/Master2/Code/test-data-func2v2.csv")
...
for i2 in range(0,len(x_train2_pre)):
    ...
    x_train2.append(dt*(exp(-x_train2_pre[i2]))) # func2 side_input = cos(x)
    ...
    for guided_nn in range(0,nn_number):
        ...
        for ii in range(0,len(x_test-1)): 
            ...
            if ((ii+1)%int((len(x_test))/test_samples) == 0) and (ii != len(x_test)-1): #new start
                ...
                side_input = dt*(exp(-predictions[ii][input_shape-1])) # func2
...
line_plot_nn.savefig("line_figure_normal.2.pdf")
line_plot_l1.savefig("line_figure_l1.2.pdf")
line_plot_l2.savefig("line_figure_l2.2.pdf")
line_plot_l3.savefig("line_figure_l3.2.pdf")
line_plot_l4.savefig("line_figure_l4.2.pdf")
...
bar_plot.savefig("bar_figure_func2.pdf")
